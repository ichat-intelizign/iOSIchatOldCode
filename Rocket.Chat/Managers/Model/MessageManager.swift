...
extension MessageManager {
    ...
    static func starmesage(_ message: Message ,pinned: Bool , completion: @escaping MessageCompletion) {
        guard let messageIdentifier = message.identifier else { return }

        let request = [
            "msg": "method",
            "method": "starMessage",
            "params": [ ["rid": message.rid, "_id": messageIdentifier, "starred": pinned] ]
            ] as [String: Any]
