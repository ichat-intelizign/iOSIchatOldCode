...
final class AuthViewController: BaseViewController {
   ...
   // var serverURL: URL!
    internal let defaultURL = "https://ichat.intelizi.com"
    var serverURL: URL? {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        setupLoginServices()
        NotificationCenter.default.addObserver(self, selector: #selector(self.newConeectFunc), name: NSNotification.Name(rawValue: "connectSer"), object: nil)
//
