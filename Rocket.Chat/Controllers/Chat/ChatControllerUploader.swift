...
extension ChatViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String: Any]) {
        ...
        let alertpopup = UIAlertController(title: "Do you want to upload File?", message: nil, preferredStyle: .alert)
        alertpopup.addAction(UIAlertAction(title: localized("Send"), style: .default, handler: { (_) in
        ...
        alertpopup.addAction(UIAlertAction(title: localized("global.cancel"), style: .cancel, handler: nil))
