...
class AuthSpec: XCTestCase {
    ...
    func testAPIHost() {
        let object = Auth()
        object.serverURL = "wss://ichat.intelizi.com/websocket"

        XCTAssertEqual(object.apiHost?.absoluteString, "https://ichat.intelizi.com/", "apiHost returns API Host correctly")
    }
}
